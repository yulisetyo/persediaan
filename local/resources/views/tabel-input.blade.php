...
<div class="well">
	...
	<div class="panel panel-warning" id="div_tabel">
		...
		<!-- <div class="btn btn-default" id="btn_refresh"><i class="glyphicon glyphicon-refresh"></i> Refresh</div> -->
		<div class="panel-heading text-right">
			<a href="{{$baseurl}}/input/create" class="btn btn-sm btn-default" id="tambah"><i class="glyphicon glyphicon-plus"></i> Rekam</a>
		</div>
		<div class="panel-body">
...
jQuery(document).ready(function () {
	...
	var table=jQuery('#tabel_ruh').DataTable({
		...
		columns: [
			...
			{data: 'satuan', name: 'satuan', className: 'text-right', searchable:true},
			{data: 'kuantitas', name: 'kuantitas', className: 'text-right', searchable:true},
			{data: 'nilai', name: 'nilai', className: 'text-right', searchable:true},
	...
	jQuery('body').off('click', '.ubah').on('click', '.ubah', function(){
		...
		window.location.replace(baseurl+'/input/pilih/'+id)
	});
	...
	jQuery('body').off('click', '.hapus').on('click', '.hapus', function(){
		...
		jQuery.get(baseurl+'/token', function(token){
			jQuery.ajax({
				url: baseurl+'/input/hapus?_token='+token,
				method: 'POST',
				data: {id: id},
